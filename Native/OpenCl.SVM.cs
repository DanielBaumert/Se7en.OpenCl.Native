...
namespace Se7en.OpenCl.Native
{
    public unsafe static partial class NativeCl
    {
        ...
        /// <returns></returns>
        [DllImport(InternalLibLoader.OpenCL, EntryPoint = nameof(clSVMAlloc))]
        public static extern IntPtr SVMAlloc(IntPtr context,  int flags, IntPtr size, uint alignment = 0);
        /// <summary>
        ...
        /// </param>
        /// <returns></returns>
        [DllImport(InternalLibLoader.OpenCL, EntryPoint = nameof(clSVMFree))]
        public static extern int SVMFree(IntPtr context, IntPtr svmPointer);
        ...
        /// <param name="e"></param>
        /// <returns></returns>
        [DllImport(InternalLibLoader.OpenCL, EntryPoint = nameof(clEnqueueSVMMap))]
        public static extern int EnqueueSVMMap(IntPtr commandQueue, int blockingMap, ulong mapFlags, IntPtr svmPtr, IntPtr size, uint numEventsInWaitList, [In][MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt, SizeParamIndex = 5)] IntPtr[] eventWaitList, [Out][MarshalAs(UnmanagedType.Struct)] out IntPtr e);
        ...
        /// </param>
        /// <returns></returns>
        [DllImport(InternalLibLoader.OpenCL, EntryPoint = nameof(clEnqueueSVMUnmap))]
        public static extern int EnqueueSVMUnmap(IntPtr commandQueue, IntPtr svmPtr, uint numEventsInWaitList, [In][MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.SysUInt, SizeParamIndex = 2)] IntPtr[] eventWaitList, [Out][MarshalAs(UnmanagedType.Struct)] out IntPtr e);
        ...
        /// </param>
        /// <returns></returns>
        [DllImport(InternalLibLoader.OpenCL, EntryPoint = nameof(clSetKernelArgSVMPointer))]
        public static extern int SetKernelArgSVMPointer(IntPtr kernel, uint argIndex, IntPtr arg);
    }
}